...
class Generator32(nn.Module):
    def __init__(self, code_dim=100, n_class=100, SN=True,size=64):
        ...
        self.conv = nn.ModuleList([ConvBlock(512, 512, n_class=n_class,SN=SN),
                                   ConvBlock(512, 256, n_class=n_class,SN=SN),
                                   SelfAttention(256,SN=SN),
                                   ConvBlock(256, 128, n_class=n_class,SN=SN),
                                   SelfAttention(128, SN=SN),
                                   ConvBlock(128, 64, n_class=n_class,SN=SN,upsample=False)])
...
class Discriminator32(nn.Module):
    def __init__(self, n_class=100,size=64,SN=True):
        ...
        self.conv = nn.Sequential(conv(64, 128,SN=SN,downsample=False),
                                  conv(128, 256,SN=SN),
                                  SelfAttention(256,SN=SN),
                                  conv(256, 512,SN=SN),
